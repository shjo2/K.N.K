...
void analyze_hand(int hand[RANK][SUIT], bool* straight, bool* flush, bool* four, bool* three, int* pairs);
...
int main(void) {
    ...
    bool straight, flush, A, five, four, three;
    int pairs;

    for (;;) {
        read_cards(hand);
        analyze_hand(hand, &straight, &flush, &four, &three, &pairs);
